...
public class BuscaTodosTelefonesDoAlunoTask extends AsyncTask<Void, Void, List<Telefone>> {
    ...
    public BuscaTodosTelefonesDoAlunoTask(
    ...
    @Override
    protected void onPostExecute(List<Telefone> telefonesEncontrados) {
        super.onPostExecute(telefonesEncontrados);
        listener.quandoEncontrados(telefonesEncontrados);
    }

    public interface TelefonesDoAlunoEncontradosListener {
        void quandoEncontrados(List<Telefone> telefonesEncontrados);
    }
}
